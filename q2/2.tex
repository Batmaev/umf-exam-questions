...
Характеристическое уравнение: $\brs{\displaystyle\pd{\omega}{t}}^2 - a^2(\grad(\omega))^2 = 0$
...
Подходит $\omega(t,x) = t-C = 0 \quad   \Rightarrow \quad $характеристики --- это гиперплоскости $t=C$
\end{example}

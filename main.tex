...
\usepackage{amssymb}
\usepackage{mleftright}   % Аналоги \left( \right) без странных отступов
...
\newcommand{\while}[2]{\mleft. #1 \vphantom{\bigr|}\mright|_{#2}}
% \while{u}{t = 0}    ---->    u|_{t=0}
% Высота образующейся вертикальной палочки 
% равна max(height(#1), height(\bigr|)) 


\newcommand{\roundBr} [1]{\mleft( #1 \mright)}
\newcommand{\squareBr}[1]{\mleft[ #1 \mright]}
\newcommand{\curlyBr}[1]{\mleft\{ #1 \mright\}}
\newcommand{\angleBr}[1]{\mleft\langle #1 \mright\rangle}

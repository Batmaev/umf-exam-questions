...
\usepackage[colorlinks = true, urlcolor = blue, linkcolor = DarkBlue]{hyperref}
\usepackage{subfiles}
...
\titleformat{\section}[block]{\Large\bfseries}{Билет \thesection. }{0pt}{}

\setcounter{secnumdepth}{1}
\newcommand{\Subsection}[1]{\phantomsection\subsection{#1}}
\newcommand{\Subsubsection}[1]{\phantomsection\subsubsection{#1}}
% Считаю, что subsections не нужны номера.

...
\section{Интегральное представление решений уравнений Лапласа и Пуассона в ограниченной области. Фундаментальное решение уравнения Лапласа (случай $\R^3$).}
...
\item $\oint_\gamma u(y) \pd{}{\vec{n}_y} \brk*{-\frac{1}{4\pi} \cdot \frac{1}{|x-y|}}dS_y  = \frac{1}{4\pi \varepsilon^2} \oint_\gamma \brk*{u(y) - u(x) + u(x)}dS_y = \\  \frac{1}{4\pi \varepsilon^2} \oint_\gamma \brk*{u(y) - u(x)}dS_y + u(x)$, \text{ где}\\

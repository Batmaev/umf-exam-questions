...
\begin{center}
\includegraphics[width=0.4\textwidth]{pic 4.pdf}
\end{center}
...
\begin{center}
%\includegraphics[width=0.3\textwidth]{4_2_new}
\begin{tikzpicture}
  \tikzstyle{axes}=[]
  ...
  \tikzstyle{information text}=[rounded corners,fill=red!10,inner sep=1ex]
   ...
   \begin{scope}[style=axes]
    ...
    \draw[->] (0,-1.7) -- (0,1.8) node[left] {$t$};
    \end{scope}
    \coordinate (A) at (-2.6, 1.7);
    \coordinate (B) at (2.6, -1.7);
    \coordinate (C) at (2.6, 1.7);
	
    \draw[draw = none, pattern = north east lines, pattern color = blue] (A) -- (B) -- (C) -- cycle;

...
\begin{itemize}
\item Пусть $T > 0, \sigma \geq 0$. {\bf Слой толщины T} - множество $\Pi_T =\curlyBr{(t,x): 0 < t < T; x \in \R^n}$\\
...
\item $u_T \in C^\infty \curlyBr{t<T, x \in \R^n}$

\item $\pd{u_T}{t} = \squareBr{\dfrac{n}{2(T-t)^\frac{n}{2}} + \dfrac{1}{(T-
t)^{\frac{n}{2}}}{\dfrac{\abs{x}^2}{4a^2(T-t)^2}}}
\exp^{\dfrac{\abs{x}^2}{4a^2(T-t)}}$

\item $\Delta_xu_T = \squareBr{\dfrac{1}{(T-t)^\frac{n}
...
однородной ЗК $\curlyBr{\mathrm{L}v = 0, \while{v}{t=0}}$.
...
$\abs{v} \leq A \exp^{\alpha \abs{x}^2} \Forall t, x \in
 ...
 \alpha : T_1 = \min\curlyBr{T, \dfrac{1}{16\alpha a^2}}$\\
 ...
 \omega_e^{\pm}(t,x) \geq \varepsilon u_{2T_1} - \abs{v(t,x)} \geq \varepsilon  u_{2T_1}
  ...
  \exp^{\dfrac{\abs{x}^2}{4a^2 2(T_1)}} - A\exp^{\alpha \abs{x}^2}=
   ...
   \squareBr{1 - 
      ...
      \exp^{-\roundBr{\frac{1}{8a^2(T_1)}-\alpha}\abs{x}^2}}  
      }
 $\\

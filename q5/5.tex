...
\begin{proof}
В силу леммы имеем 
$\while{u}{t=0} = 0;\ \while{u_t}{t=0} = u_1$.
...
\item $ \while{u}{t=0} = \while{v_t}{t=0} = u_0(x) $

\item $\while{u_t}{t=0} = \while{v_{tt}}{t=0} = a^2 \Delta \while{v}{t=0} = 0$ 
%
(на гиперплоскости  $t=0  \colon\ 
                 \while{v}{t=0} \equiv 0\ \Rightarrow\ 

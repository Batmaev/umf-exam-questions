...
\footnote{Если расписать мультииндексы: $\partial^{\alpha_0}_t \partial^{\alpha_1}_{x_1} \partial^{\alpha_2}_{x_2} \partial^{\alpha_3}_{x_3} \; 
u_g(t, x, \tau) \in C \;\Forall \alpha_i \colon \sum\limits_{i=0}^{3} \alpha_i \leq p$}

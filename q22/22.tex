...
Фиксируем $\varepsilon >0$ и рассмотрим функции $W_\epsilon^{\pm} =
\frac{\varepsilon}{|x|} \mp v(x)$.

Функции $W_\epsilon^{\pm}$ также гармонические в $(0<|x|<r)$, непрерывны на $(0<|x| \le r)$, а 
$\left.W_\epsilon^{\pm}(x) \right|_{|x|=r} =\frac{\epsilon}{|x|} >0$.
}
...
$$
W_\varepsilon^{\pm} = \frac{\epsilon}{|x|} \mp v(x) \ge 
\frac{\epsilon}{|x|} - |v(x)|
\ge 
\frac{\epsilon}{|x|}\sbrs{1 - \frac{|x|\cdot |v(x)|}{\varepsilon}}
\ge
\frac{\epsilon}{|x|}\sbrs{1-\frac{1}{2}}
=
...
При $\delta \le |x| \le r$  функции $W_\epsilon^{\pm}(x)$

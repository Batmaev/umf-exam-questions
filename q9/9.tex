...
$$u(t,x) = \sum_{k=1}^{N}\sbrs{\frac{\fbrs{-\frac{1}{2}\erf \brs{\frac{x-x_{2k}}{\sqrt{4a^2t}}}}-\fbrs{-\frac{1}{2}\erf \brs{\frac{x-x_{1k}}{\sqrt{4a^2t}}}}}{x_{2k}-x_{1k}}}u_{*k} \cdot (x_{2k} - x_{1k})$$
...
\begin{align*}
u(t,x) &= \sbrs{
		\Psi (t,x, \xi) = -\frac{1}{2} \erf\brs{\frac{x - \xi}{\sqrt{4a^2t}}}

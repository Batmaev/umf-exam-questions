...
\begin{itemize}
	...
	$$\forall\, \alpha, \beta \in \mathcal{D} \quad \bigl(\exists!\,\gamma \in \mathcal{D} \quad u_\alpha \circ u_\beta = u_\gamma \bigr)$$
...
\begin{definition}
	...
	\end{definition}
	\begin{definition}
	Говорят, что \textit{уравнение допускает однопараметрическую группу преобразований}, если оно инвариантно относительно всех преобразований группы.
\end{definition}
